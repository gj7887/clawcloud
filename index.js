...
class Config {
  constructor() {
    ...
    this.ARGO_DOMAIN = process.env.ARGO_DOMAIN || "leaflow.8.2.9.a.f.f.0.7.0.0.6.2.ip6.arpa";                           // 固定隧道域名,留空即启用临时隧道
    this.ARGO_AUTH = process.env.ARGO_AUTH || "eyJhIjoiYjQ3YzViY2UxYmM5OTNkYjc3YzQwMjE3MWE1ZDhiNmIiLCJ0IjoiMzY2NjY2YTMtNTY4Yy00NzAwLWE3MzYtMjI0NjlhNDVlM2E1IiwicyI6Ik16azFaamMyWVRRdE5qbGtZaTAwTVdNeExUZzBNRE10WWpnMlpUQXdPR1V5TlRJMCJ9";                               // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
    ...
    this.NAME = process.env.NAME || "leaflow";                                         // 节点名称
  }
}
